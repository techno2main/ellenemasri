(function () {
	...
	document.addEventListener('DOMContentLoaded', function () {
		...
		function syncSwitchTheme() {
			if (!releaseSection || !instances.length) {
				return;
			}
			...
			if (navColor) {
				releaseSection.style.setProperty('--em-release-switch-color', navColor);
			} else {
				releaseSection.style.removeProperty('--em-release-switch-color');
			}
		}
