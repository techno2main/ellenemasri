(function () {
    ...
    function buildSelect(id, choices, value, field) {
        ...
        wrap.className = 'em-site-template-wizard-catalog__field';
        ...
        select.id = id;
        select.className = 'em-site-template-wizard-catalog__select';
    ...
    EmWpTemplateWizard.Catalog = {
        bind: function (root) {
            var host = root.querySelector('#em-site-template-wizard-catalog-panels');
            var self = this;
            ...
            this.render = function () {
                ...
                order.forEach(function (slug) {
                    ...
                    panel.className = 'em-site-template-wizard-catalog__panel';
                    panel.setAttribute('data-catalog-rubrique', slug);

                    var title = document.createElement('h3');
                    title.className = 'em-site-template-wizard-catalog__title';
                    ...
                    if (slug === 'header') {
                        ...
                        panel.appendChild(buildSelect(
                            'em-site-wizard-header-hero',
                            State.config.catalogs.heroes || [],
                            header.hero_slug || '',
                            { key: 'hero_slug', label: 'Hero' }
                        ));
                        panel.appendChild(buildSelect(
                            'em-site-wizard-header-slider',
                        ...
                        hint.className = 'em-site-template-wizard-catalog__hint';
