...
function em_site_social_item_option_name(string $template_slug): string
{
	$instance_option = function_exists('em_site_instance_option_name')
		? em_site_instance_option_name($template_slug, 'social')
		: 'em_site_instance_' . $template_slug . '_social';
	...
	return function_exists('em_site_item_option_name')
		? em_site_item_option_name('social', $item_slug)
		: 'em_site_item_social_' . $item_slug;
}
