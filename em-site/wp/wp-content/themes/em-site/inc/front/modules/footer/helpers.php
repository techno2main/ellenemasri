...
function em_site_footer_item_option_name(string $template_slug): string
{
	$instance_option = function_exists('em_site_instance_option_name')
		? em_site_instance_option_name($template_slug, 'footer')
		: 'em_site_instance_' . $template_slug . '_footer';
	...
	return function_exists('em_site_item_option_name')
		? em_site_item_option_name('footer', $item_slug)
		: 'em_site_item_footer_' . $item_slug;
}
