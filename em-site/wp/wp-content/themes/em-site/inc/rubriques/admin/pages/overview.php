...
function em_site_ordered_types(): array
{
    ...
    $custom_order = function_exists('em_site_get_rubrique_order') ? em_site_get_rubrique_order() : [];
...
function em_site_overview_render(): void
{
    ...
    <?php if (function_exists('em_site_overview_render_accessibility_script')) { em_site_overview_render_accessibility_script(); } ?>
    <script>
    (function () {
