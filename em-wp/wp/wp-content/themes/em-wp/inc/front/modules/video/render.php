...
/**
 * Rendu HTML de la section video sans template-part legacy.
 *
 * @param array<string, mixed> $video
 */
function em_wp_render_video_section(array $video): void
{
...
function em_wp_render_video(): void
{
    ...
    $options = function_exists('em_wp_video_get_options_for_front')
        ? em_wp_video_get_options_for_front()
        : em_wp_video_get_options();
    ...
    em_wp_render_video_section($options);
}
