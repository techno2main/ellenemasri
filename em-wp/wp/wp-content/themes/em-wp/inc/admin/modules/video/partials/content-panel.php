...
function em_wp_video_render_content_panel_body(array $options, ?string $field = null): void
{
    ...
    <label><span><?php esc_html_e('Titre', 'em-wp'); ?></span><input type="text" class="regular-text" name="<?php echo esc_attr($field); ?>[title]" value="<?php echo esc_attr($options['title']); ?>"></label>
