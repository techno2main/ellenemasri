...
function em_wp_footer_render_content_panel_body(array $options, ?string $field = null): void
{
    $field = $field ?? em_wp_footer_form_option_key();
    ?>
...
function em_wp_footer_render_sticky_panel_body(array $options, ?string $field = null): void
{
    $field = $field ?? em_wp_footer_form_option_key();
    ?>
