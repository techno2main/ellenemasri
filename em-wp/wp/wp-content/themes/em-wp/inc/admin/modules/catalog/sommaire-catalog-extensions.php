...
function em_wp_catalog_extended_menu_definitions(): array
{
    return [
        'top-bars' => [
            ...
            'available'   => true,
            'description' => __('Liste des Top-Bars réutilisables dans la rubrique TOP-BAR.', 'em-wp'),
        ...
        'releases' => [
            ...
            'available'   => true,
            'description' => __('Liste des Releases réutilisables dans la rubrique RELEASES.', 'em-wp'),
        ...
        'ctas' => [
            ...
            'available'   => true,
            'description' => __('Liste des CTA réutilisables dans la rubrique CTA.', 'em-wp'),
        ...
        'footers' => [
            ...
            'available'   => true,
            'description' => __('Liste des Footers réutilisables dans la rubrique FOOTER.', 'em-wp'),
...
function em_wp_catalog_render_top_bars_page(): void
{
    em_wp_catalog_render_generic_crud_hub_page([
        ...
        'icon'              => 'dashicons-menu-alt',
        'type'              => 'top-bar',
        'section_title'     => __('MES TOP-BARS', 'em-wp'),
...
function em_wp_catalog_render_releases_page(): void
{
    em_wp_catalog_render_generic_crud_hub_page([
        ...
        'icon'              => 'dashicons-album',
        'type'              => 'release',
        'section_title'     => __('MES RELEASES', 'em-wp'),
...
function em_wp_catalog_render_ctas_page(): void
{
    em_wp_catalog_render_generic_crud_hub_page([
        ...
        'icon'              => 'dashicons-megaphone',
        'type'              => 'cta',
        'section_title'     => __('MES CTA', 'em-wp'),
