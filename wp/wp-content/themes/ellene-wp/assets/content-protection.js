(function() {
  ...
  function convertInternalAnchors(root) {
    ...
    anchors.forEach(function(anchor) {
      if (anchor.hasAttribute('data-mayami-scroll-bound')) {
        return;
      }
      ...
      button.setAttribute('aria-label', anchor.getAttribute('aria-label') || anchor.textContent.trim() || 'Aller à la section');
      button.setAttribute('data-scroll-target', target);
      button.setAttribute('data-mayami-scroll-bound', '1');
