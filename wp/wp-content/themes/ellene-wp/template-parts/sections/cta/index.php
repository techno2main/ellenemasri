...
<section id="cta" class="relative overflow-hidden bg-[oklch(0.68_0.17_182)] py-10 text-ink sm:py-20">
    ...
    <div class="relative mx-auto max-w-5xl px-5 sm:px-8">
        ...
        <div class="flex items-start justify-between gap-3">
            ...
            <div>
                ...
                <h2 class="mt-2 font-display text-5xl leading-[0.9] text-black sm:text-7xl">
