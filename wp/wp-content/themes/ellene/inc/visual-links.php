            ...
            <div class="mayami-vlb-proto-main">
                ...
                <div class="mayami-vlb-canvas-area">
                    ...
                    <div class="mayami-vlb-form-grid">
                        ...
                        <label class="mayami-vlb-form-grid__full">
                            ...
                            <input type="text" class="regular-text mayami-vlb-input" data-vlb-field="imageAlt" placeholder="Visuel cliquable de Mayami">
                ...
                <aside class="mayami-vlb-sidebar">
                    ...
                    <div class="mayami-vlb-workflow-box">
                        ...
                        <p class="mayami-vlb-workflow-note">Prévisualisation et publication utilisent la dernière version enregistrée. Sauvegardez Mayami Landing avant ces actions.</p>
...
function mayami_handle_publish_visual_links_draft() {
    ...
    if (!current_user_can('manage_options')) {
        ...
        wp_die(esc_html__('You are not allowed to do this.', 'ellene'), 403);
